...
TFile *plotsfile = new TFile ("/Users/rmshaffer/RMSRecon_v1/plots/test.root","recreate");
...
TFile *plotsfile = new TFile ("/Users/rmshaffer/RMSRecon_v1/plots/test.root","update");
...
TLorentzVector rxnAlpha, target, beam, lith6_alpha, lith6_deut, deut_calc, dAlpha_obs, dAlpha_calc, deut_obs;
	...
	double beamKErxn = beamKE - 0.011; //energy loss from LISE++ calculation
